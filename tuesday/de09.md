...
API Keys as required + internal parameters with a default value. Doesn't expose key to user, but also allows them to connect without needing to know the API Key.